...
const IMAGE_BASE_URL = "https://backend.thevaultldn.com/products/";
...
const fetchProduct = async () => {
  try {
    const response = await fetch(
      `https://backend.thevaultldn.com/getProduct.php?id=${productId}`
    );
...
const updateProduct = async () => {
  ...
  try {
    const response = await fetch(
      "https://backend.thevaultldn.com/updateProduct.php",
      {
        method: "POST",
        headers: {
